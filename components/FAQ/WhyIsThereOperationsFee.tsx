export default function WhyIsThereOperationsFee() {
  return (
    <div className=" flex flex-col gap-4 text-xs ">
      ...
      <p className="break-words whitespace-pre-line">
        ...
        platform, generating your Butter NFTs, improving the user experience,
      ...
      <p className="break-words whitespace-pre-line">
        All transactions are recorded on-chain, so you can track where every
        token goes.
      </p>
      <p className="break-words whitespace-pre-line">
        We believe that doing good should be sustainable. A little support keeps
        the kindness flowing.
      </p>
    </div>
  );
}
